...
export const dataset_name_basic: Dataset<{ address: string }> = [
    { label: "ETHRegistry_1", arg: "luc.eth", expected: { address: "0x225f137127d9067788314bc7fcc1f36746a3c3B5" } },
...
export const dataset_address_basic: Dataset<{ name: string }> = [
    { label: "ETHRegistry_1", arg: "0x225f137127d9067788314bc7fcc1f36746a3c3B5", expected: { name: "luc.eth" } },
    { label: "ETHRegistry_2", arg: "0xb8c2C29ee19D8307cb7255e1Cd9CbDE883A267d5", expected: { name: "nick.eth" } },
...
export const dataset_universal_basic: Dataset<{ address: string} | {name: string }> = [
    { label: "ETHRegistry_1", arg: "luc.eth", expected: { address: "0x225f137127d9067788314bc7fcc1f36746a3c3B5" } },
    { label: "ETHRegistry_2", arg: "0xb8c2C29ee19D8307cb7255e1Cd9CbDE883A267d5", expected: { name: "nick.eth" } },
    { label: "DNSRegistry", arg: "luc.computer", expected: { address: "0x225f137127d9067788314bc7fcc1f36746a3c3B5" } },
    { label: "DNSRegistry", arg: "0x2B5c7025998f88550Ef2fEce8bf87935f542C190", expected: { name: "antony.sh" } },
